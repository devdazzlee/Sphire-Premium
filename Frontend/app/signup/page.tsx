    ...
    <div className="min-h-screen bg-[#f5f1e8] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <img src="/sphire-premium-logo.png" alt="Sphire Premium" className="w-16 h-16 mx-auto mb-4" />
          <h1 className="text-2xl font-light text-gray-800">Join Sphire Premium</h1>
          <p className="text-gray-600 font-light">Create your account to get started</p>
        </div>
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 border-gray-200 focus:border-gray-400"
                    required
                  />
                  <button
                    type="button"

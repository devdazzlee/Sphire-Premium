...
export function ModernHeroBanner() {
  ...
  return (
    <section className="relative min-h-[90vh] lg:h-[80vh] bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 lg:py-12">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(90vh-4rem)] lg:h-full">
          {/* Content Side */}
          <div className={`space-y-3 lg:space-y-4 transition-all duration-700 ease-out ${
            ...
            <div className="flex flex-col sm:flex-row gap-2 lg:gap-3">
              <Button
                ...
                size="lg"
                className="bg-white text-black hover:bg-gray-100 font-semibold py-2 lg:py-2.5 px-4 lg:px-6 text-xs lg:text-sm rounded-lg transition-all duration-300 hover:scale-105 shadow-lg"
              >
                Shop Collection
              ...
              <Button
                variant="outline"
                size="lg"
                className="bg-white/20 backdrop-blur-sm border-white text-white hover:bg-white/30 font-semibold py-2 lg:py-2.5 px-4 lg:px-6 text-xs lg:text-sm rounded-lg transition-all duration-300 hover:scale-105"
              >
                Learn More
              </Button>
            </div>
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-3 lg:gap-4 pt-3 lg:pt-4 border-t border-white/20">
              <div className="text-center">
                <div className="text-lg lg:text-xl font-bold text-white">50K+</div>
                <div className="text-[10px] lg:text-xs text-gray-400">Happy Customers</div>
              </div>
              <div className="text-center">
                <div className="text-lg lg:text-xl font-bold text-white">4.9</div>
                <div className="text-[10px] lg:text-xs text-gray-400">Average Rating</div>
              </div>
              <div className="text-center">
                <div className="text-lg lg:text-xl font-bold text-white">100%</div>
                <div className="text-[10px] lg:text-xs text-gray-400">Natural</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative mt-6 lg:mt-0">
            <div className={`relative transition-all duration-700 ease-out ${
              ...
              <div className="relative w-full h-[280px] sm:h-[350px] lg:h-[450px] rounded-2xl overflow-hidden shadow-xl">
                <Image
                ...
                {/* Floating Elements */}
                <div className="absolute top-4 sm:top-8 right-4 sm:right-8 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl p-2 sm:p-4 border border-white/30">
                  <div className="flex items-center gap-1 sm:gap-2 text-white">
                    ...
                    <span className="text-xs sm:text-sm text-gray-300 hidden sm:inline">(2.1k reviews)</span>
                  </div>
                </div>

                <div className="absolute bottom-4 sm:bottom-8 left-4 sm:left-8 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl p-2 sm:p-4 border border-white/30">
                  <div className="text-white">
                    <div className="text-xs sm:text-sm text-gray-300">Starting from</div>
                    <div className="text-lg sm:text-2xl font-bold">Rs 29.99</div>
                  </div>
                </div>
              </div>
              ...
              <button
                onClick={prevSlide}
                className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white p-2 sm:p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 border border-white/30"
              >
                <ChevronLeft className="w-4 sm:w-6 h-4 sm:h-6" />
              </button>
              <button
                onClick={nextSlide}
                className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white p-2 sm:p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 border border-white/30"
              >
            ...
            {/* Decorative Elements */}
            <div className="absolute -top-4 -left-4 w-16 sm:w-24 h-16 sm:h-24 bg-gradient-to-br from-blue-400/30 to-purple-400/30 rounded-full blur-xl"></div>
            <div className="absolute -bottom-4 -right-4 w-20 sm:w-32 h-20 sm:h-32 bg-gradient-to-br from-pink-400/30 to-rose-400/30 rounded-full blur-xl"></div>
          </div>
        </div>
